...
class FxAutoCompletionMaterialPo extends HookConsumerWidget {
  final double? width;
  final String value;
  ...
  const FxAutoCompletionMaterialPo(
      {Key? key,
      this.width,
      this.optionWidth,
      this.hintText,
                                ...
                                child: Row(
                                  children: [
                                    Text(
                                      ...
                                      style: TextStyle(
                                        fontSize: 16,
                                        // color: model.fromVendor == "N" &&
                                        //         fromVendorStyling
                                        //     ? Constants.textNotFromVendor
                                        //     : null,
                                        // fontStyle: model.fromVendor == "N" &&
                                        //         fromVendorStyling
                                        //     ? FontStyle.italic
                                        //     : null,
                                      ),
