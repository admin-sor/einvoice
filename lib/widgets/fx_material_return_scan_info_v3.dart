...
class FxMaterialReturnScanInfoV3 extends HookConsumerWidget {
  final bool isFirst;
  ...
  const FxMaterialReturnScanInfoV3(
      {super.key,
      required this.model,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final errorEditMessage = useState("");
    final ctrlEdit = TextEditingController(text: model.editQty);
    ctrlEdit.selection =
        TextSelection.fromPosition(TextPosition(offset: ctrlEdit.text.length));
    ...
    ref.listen(saveMaterialReturnStateProvider, (prev, next) {
      if (next is SaveMaterialReturnStateLoading) {
        ...
        if (index == ref.watch(selectedEditIndex))
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _QtyColumnEdit(
                        ...
                        errorEditMessage: errorEditMessage.value,
                        inEditMode:
                        ...
                        onChanged: (val) {
                          ...
                          if (val == "") {
                            ...
                            try {
                              ...
                              errorEditMessage.value = e.toString();
                              return;
                            }
                            if (ctrlVal <= 0) {
                              return;
                            ...
                            try {
                              orgPackSizeVal =
                                  double.parse(model.packsizeOriginal);
                            } catch (e) {
                              return;
                            }
                            if (ctrlVal <= orgPackSizeVal) {
                              errorEditMessage.value = "";
                            } else {
                              errorEditMessage.value =
